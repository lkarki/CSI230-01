file="ipCounterOutput.txt"
while read -r line;
do

num1=$(echo $line | cut -c 1-8)
num2=$(echo $line | cut -c 9-16)
num3=$(echo $line | cut -c 17-24)
num4=$(echo $line | cut -c 25-32)
